import 'package:brew_buds/search/core/search_presenter.dart';

typedef RecommendedBeanState = ({String imageUri, String title, double rating, int commentsCount});
...
final List<RecommendedBeanState> _coffeeBeanDummy = [
  (imageUri: 'https://loremflickr.com/600/400', title: '에티오피아 시다모 G2 워시드', rating: 4.8, commentsCount: 220),
  (imageUri: 'https://loremflickr.com/600/400', title: '에티오피아 구지 시다모 G1', rating: 4.8, commentsCount: 220),
  (imageUri: 'https://loremflickr.com/600/400', title: '에티오피아 예가체프 G4', rating: 4.8, commentsCount: 220),
  (imageUri: 'https://loremflickr.com/600/400', title: '에티오피아 아리차 예가체프 G1 내추럴', rating: 4.8, commentsCount: 220),
  (imageUri: 'https://loremflickr.com/600/400', title: '에티오피아 시다모 G2 워시드', rating: 4.8, commentsCount: 220),
  (imageUri: 'https://loremflickr.com/600/400', title: '에티오피아 구지 시다모 G1', rating: 4.8, commentsCount: 220),
  (imageUri: 'https://loremflickr.com/600/400', title: '에티오피아 예가체프 G4', rating: 4.8, commentsCount: 220),
  (imageUri: 'https://loremflickr.com/600/400', title: '에티오피아 아리차 예가체프 G1 내추럴', rating: 4.8, commentsCount: 220),
