                                    ...
                                    return Offstage(
                                      ...
                                      child: const Stack(
                                        children: [
                                          ...
                                          Center(child: CircularProgressIndicator(color: ColorStyles.gray70)),
                                        ],
                                      ),
                                    );
                                  } else {
                            ...
                            children: [
                              Visibility(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      Text(
                                        '${presenter.replyComment?.author.nickname}님에게 답글 남기는 중',
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                    hintText:
                                        presenter.isReply ? '답글 달기...' : '${presenter.author.nickname}님에게 댓글 추가...',
            ...
            children: [
              _buildSlidableComment(
                CommentItem(
                  ...
                  onTappedLikeButton: () {
                    presenter.onTappedLikeButton(comment: comment);
                  },
                ),
                canDelete: presenter.canDelete(comment.author.id),
                onDelete: () {
                  presenter.deleteComment(comment: comment);
                },
              ),
                  ...
                  reCommentsBuilder: (index) {
                    ...
                    return _buildSlidableComment(
                      CommentItem(
                        ...
                        isWriter: presenter.author.id == reComment.author.id,
                      ...
                      canDelete: presenter.canDelete(reComment.author.id),
                      onDelete: () {
                        presenter.deleteComment(comment: reComment);
                      },
                    );
                  },
                )
