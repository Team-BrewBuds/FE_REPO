                ...
                shrinkWrap: true,
                  ...
                  itemBuilder: (context,index){
                    return ListTile(
                      ...
                      trailing: Container(
                    margin: const EdgeInsets.only(left: 20), // title과 trailing 사이의 간격
                    child: const Icon(CupertinoIcons.right_chevron)),
                    );
              }, separatorBuilder: (BuildContext context, int index) => Divider(height: 0.5,)
              ,),
              Container(height: 14,color: ColorStyles.gray30,),
              ListView.separated(
                shrinkWrap: true,
                physics: NeverScrollableScrollPhysics(),
                         ...
                         showModalBottomSheet(
                          ...
                          return Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                TextButton(child: Text('로그아웃',style: TextStyle(color: ColorStyles.red,fontSize: 17)),
                                  onPressed: () {
