...
class TastedRecordUpdateFirstScreen extends StatefulWidget {
  const TastedRecordUpdateFirstScreen({super.key});

  @override
  State<TastedRecordUpdateFirstScreen> createState() => _TastedRecordUpdateFirstScreenState();
}
...
class _TastedRecordUpdateFirstScreenState extends State<TastedRecordUpdateFirstScreen>
            ...
            child: ThrottleButton(
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => TastedRecordUpdateLastScreen(contents: contents, tag: tag),
                  ),
                );
              },
              child: Container(
  ...
  _onChangeTaste(List<String> taste) {
    context.read<TastedRecordUpdatePresenter>().onChangeTaste(taste);
  }
}
