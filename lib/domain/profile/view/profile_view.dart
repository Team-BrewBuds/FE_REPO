                ...
                child: FutureButton<bool>(
                  onTap: () async {
                    ...
                    if (bottomSheetResult != null && bottomSheetResult && context.mounted) {
                      final responseResult = await _showAskForResponseToBlockModal();
                      if (responseResult != null && responseResult && context.mounted) {
                        return context.read<ModalProfilePresenter>().onTappedBlockButton();
                      }
                    }
