...
class _HomePostViewState extends State<HomePostView> with HomeViewMixin<HomePostView, HomePostPresenter> {
          ...
          builder: (context, page, child) => SliverList.separated(
            ...
            itemBuilder: (context, index) {
              ...
              if (index % 12 == 11) {
                ...
                return _buildPostFeed(post, index);
              }
            },
  ...
  Widget _buildPostFeed(Post post, int index) {
    ...
    return PostFeedWidget(
      ...
      onTapFollowButton: () {
        context.read<HomePostPresenter>().onTappedFollowAt(index);
      },
      ...
      onTapLikeButton: () {
        context.read<HomePostPresenter>().onTappedLikeAt(index);
      },
      onTapCommentsButton: () {
        showCommentsBottomSheet(isPost: true, id: post.id, author: post.author);
      },
      onTapSaveButton: () {
        context.read<HomePostPresenter>().onTappedSavedAt(index);
      },
      title: post.title,
      body: post.contents,
