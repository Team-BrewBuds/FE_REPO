...
class Blendwidgets extends StatefulWidget {
  const Blendwidgets({super.key});

  @override
  State<Blendwidgets> createState() => _BlendwidgetsState();
}

class _BlendwidgetsState extends State<Blendwidgets> {
  ...
  void initState() {
    super.initState();
    _expandedStates = List.generate(3, (index) => false);
  }
