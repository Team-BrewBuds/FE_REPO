                  ...
                  children: [
                    ...
                    Expanded(
                      child: Padding(
                        padding: EdgeInsets.symmetric(horizontal: 16.0),
                        child: TextFormField(
                          controller: presenter.contentController,
                          cursorColor: ColorStyles.black,
                          decoration: InputDecoration(
                            hintText: '내용을 입력하세요.',
                      ...
                      child: Row(
                        children: [
                          IconButtonFactory.buildVerticalButtonWithIconWidget(
                              iconWidget:
                                  SvgPicture.asset('assets/icons/album.svg',width: 20, height: 20,),
                              text: '사진',
                              onTapped: () {},
                          ...
                          IconButtonFactory.buildVerticalButtonWithIconWidget(
                              iconWidget: SvgPicture.asset(
                                'assets/icons/coffee.svg', width: 20, height: 20,
                              ),
                              text: '기록',
                              onTapped: () {},
                              textStyle: TextStyles.captionSmallMedium),
                          ...
                          IconButtonFactory.buildVerticalButtonWithIconWidget(
                              iconWidget:
                                  SvgPicture.asset('assets/icons/tag.svg',width: 20, height: 20,),
                              text: '태그',
                              onTapped: () {},
                              textStyle: TextStyles.captionSmallMedium),
                        ],
